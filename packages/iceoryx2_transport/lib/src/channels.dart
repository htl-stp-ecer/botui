class Channels {
  ...
  static String servoSmoothPositionCommand(int port) =>
      'raccoon/servo/$port/smooth_cmd';
  ...
  static String motorVelocityCommand(int port) =>
      'raccoon/motor/$port/velocity_cmd';
  static String motorPositionCommand(int port) =>
      'raccoon/motor/$port/position_cmd';
  static String motorRelativeCommand(int port) =>
      'raccoon/motor/$port/relative_cmd';
  static String motorPidCommand(int port) => 'raccoon/motor/$port/pid_cmd';
  static String motorPositionResetCommand(int port) =>
      'raccoon/motor/$port/position_reset_cmd';
